...
describe('testing the StackLinkedList structure', () => {
  test('create the StackLinkedList structure', () => {
    const stack = new StackLinkedList<any>();
    const emptyArray = [];
  ...
  test('add items in the StackLinkedList structure', () => {
  ...
  test('remove items in the StackLinkedList structure', () => {
    const stack = new StackLinkedList<number>();
    stack.push(2, 3, 5);
  ...
  test('peek first item in the StackLinkedList structure', () => {
    const stack = new StackLinkedList<number>();
  ...
  test('the StackLinkedList structure is empty', () => {
    const stack = new StackLinkedList<number>();
  ...
  test('method clear in the StackLinkedList structure', () => {
    const stack = new StackLinkedList<number>();
    expect(stack.size()).toBe(0);
  ...
  test('method size in the StackLinkedList structure', () => {
    const stack = new StackLinkedList<number>();
    expect(stack.size()).toBe(0);
